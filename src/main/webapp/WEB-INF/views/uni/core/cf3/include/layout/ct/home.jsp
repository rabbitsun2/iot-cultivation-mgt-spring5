			...
			<table class="ct_main_field_tbl">
				...
				<tr>
					...
					<td colspan="2" class="ct_nav_menubar">
						<nav class="ct_nav">
					        <ul>
					            <li><a href="<c:url value='/uni/core/cf3/' />">재배</a></li>
					            <li><a href="<c:url value='/uni/core/cf3/layout/acc' />">계정</a></li>
					            <li><a href="#">설명서</a></li>
					        </ul>   
					    </nav>						
					</td>
								...
								<li>
									...
									<ul>
										...
										<li>
											...
											<ul>
												<li>
													<a href="#">재배지 원격 영상 조회</a>
												</li>
												<li>
													<a href="#">주변 환경 상태 조회</a>
												</li>
												<li>
													<a href="#">일일 평균 환경 그래프 출력</a>
												</li>
											</ul>
										</li>
										<!-- Sub Menu -->
